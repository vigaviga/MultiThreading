...
namespace MultiThreading.Task3.MatrixMultiplier.Tests
{
    ...
    public class MultiplierTest
    {
        ...
        public void ParallelEfficiencyTest()
        {
            ...
            var matricesParallelMultiplier = new MatricesMultiplierParallel();

            bool parallelIsFaster = false;
            int i = 1;

            while (!parallelIsFaster)
            {
                ...
                if (t1 > t2)
                {
                    //The value for which parallel is faster varies based. It was 15, 20, 24 etc.
